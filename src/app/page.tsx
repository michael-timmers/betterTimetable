      ...
      <div className="min-h-screen flex">
        ...
        <div className="w-3/4 p-12 bg-gray-800">
          ...
          <h2>📅 Welcome to BetterTimetable</h2>
            <p>
              Welcome to BetterTimetable from Code Network! Whether you’re looking to generate a custom schedule, plan out your week, or compare different timetables, we’ve got you covered. Let’s dive into the features:
            </p>
            
            <h3 className="pt-8">Generate</h3>
            <p>
              Our <strong>Generate</strong> feature creates a timetable that fits your specific needs. Whether you're managing classes, study time, or other activities, this tool automatically arranges your schedule for you, saving you time and effort. Visit <a href="/generate">/generate</a> to get started with your customized timetable.
            </p>
